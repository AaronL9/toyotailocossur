...
export default function CsrEditPage() {
    Alpine.data("csrForm", (csrf_token: string, id: string) => ({
        csrf_token,
        submitting: false,
        ...
        async init() {
            ...
            try {
                const { data } = await axios.get(`/api/csr/${id}`);

                this.form.csr_title = data.data.csr_title;
                this.form.csr_content = data.data.csr_content;
                this.form.csr_date = data.data.csr_date;
        ...
        async submit() {
            ...
            try {
                const { data } = await axios.put(`/api/csr/${id}`, {
