...
<div class="w-full mx-auto">
  ...
  <div class="flex items-center gap-x-3 mb-5">
    ...
    <div>
      <h1 class="text-lg font-semibold text-gray-800">Vehicle Inquiry Submissions</h1>
      <p class="text-sm text-gray-500">Manage and view all users who inquired about a specific vehicle.</p>
    </div>
  </div>
  <!-- End Page Header -->
