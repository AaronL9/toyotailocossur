                ...
                <template x-for="inquiry in data" :key="inquiry.id">
                  <tr class="odd:bg-white even:bg-gray-100">
                    ...
                    <td class="px-6 py-3 whitespace-nowrap text-end text-sm font-medium">
                      <a x-bind:href="`/admin/inquiry/appointment/${inquiry.id}`" class="inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-accent-600 hover:text-accent-400 focus:outline-hidden" title="View">
