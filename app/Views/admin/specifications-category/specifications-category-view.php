...
<div x-data="SpecificationsData('<?= csrf_hash() ?>')" class="w-full mx-auto">
  <div class="max-w-2xl px-2">
    ...
    <div class="mb-6">
      ...
      <p class="text-sm text-gray-500 mt-1">Manage your specification category list below.</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6">
      ...
      <ul id="spec-list" class="flex flex-col gap-y-2 max-h-72 overflow-y-auto pr-1">
        <template x-for="row in filteredData" :key="row.scat_no">
          <li class="flex items-center justify-between px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg group hover:border-gray-300 hover:bg-gray-100 transition-colors duration-150">
            ...
            <div class="flex items-center gap-x-1">
              <button @click="edit(row.scat_title, row.scat_no)" type="button" class="p-1.5 inline-flex items-center justify-center text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-md transition-colors duration-150">
