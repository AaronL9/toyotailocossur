    ...
    <nav class="flex-1 overflow-y-auto p-4 space-y-1 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300">
      ...
      <div class="mb-4">
        ...
        <ul class="space-y-0.5">
          <li>
            <a class="flex items-center gap-x-3 py-2.5 px-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?= str_contains(uri_string(), "admin/users") ? "bg-primary-50 text-primary-600 hover:bg-primary-50" : "" ?>" href="<?= base_url("admin/governance") ?>">
              <i class="fa-solid fa-user-tie w-5 text-center <?= str_contains(uri_string(), "admin/users") ? "text-primary-600" : "text-gray-500" ?>"></i>
              Users
            </a>
          </li>
          <li>
            <a class="flex items-center gap-x-3 py-2.5 px-3 text-sm font-medium text-gray-700 rounded-lg hover:bg-gray-100 transition-colors <?= str_contains(uri_string(), "admin/vehicles") ? "bg-primary-50 text-primary-600 hover:bg-primary-50" : "" ?>" href="<?= base_url("admin/hotlines") ?>">
