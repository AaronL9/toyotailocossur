...
<div x-data="AgentCreate('<?= csrf_hash() ?>')" class="flex flex-row-reverse flex-wrap justify-end gap-3 w-full">
  ...
  <!-- Form -->
  <form @submit.prevent="add($event)" id="agent-add-form" method="post" enctype="multipart/form-data" class="w-full max-w-3xl">
    ...
    <div class="flex justify-end pt-4">
      <button
        ...
        <span x-text="loading ? 'Loading...' : 'Add Agent'"></span>
      </button>
    </div>
